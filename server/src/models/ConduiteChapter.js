...
const conduiteChapterSchema = new mongoose.Schema(
  {
...
conduiteChapterSchema.methods.toAdminJSON = function toAdminJSON() {
  return {
    id: this._id,
    name: this.name,
    order: this.order,
...
conduiteChapterSchema.methods.toPublicJSON = function toPublicJSON() {
  return {
    id: this._id,
    name: this.name,
    order: this.order,
...
export const ConduiteChapter = mongoose.model('ConduiteChapter', conduiteChapterSchema)
