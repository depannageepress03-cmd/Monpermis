...
export function fetchChapters(token: string) {
  return apiFetch<{ chapters: Chapter[] }>('/api/admin/revision/chapters', {}, token)
}
...
export function updateChapter(
  ...
  return apiFetch<{ chapter: Chapter }>(
    `/api/admin/revision/chapters/${chapterId}`,
...
export function reorderChapters(token: string, orderedIds: string[]) {
  return apiFetch<{ chapters: Chapter[] }>(
    '/api/admin/revision/chapters/reorder',
...
export function duplicateChapter(token: string, chapterId: string) {
  return apiFetch<{ chapter: Chapter }>(
    `/api/admin/revision/chapters/${chapterId}/duplicate`,
    { method: 'POST' },
    token,
  )
}
...
export function createCourse(token: string, chapterId: string, title: string) {
  return apiFetch<{ course: Course }>(
    `/api/admin/revision/chapters/${chapterId}/courses`,
...
export function updateCourse(
  ...
  return apiFetch<{ course: Course }>(
    `/api/admin/revision/chapters/${chapterId}/courses/${courseId}`,
    { method: 'PATCH', body: JSON.stringify(payload) },
    token,
  )
}
...
export function reorderCourses(token: string, chapterId: string, orderedIds: string[]) {
  return apiFetch<{ chapter: Chapter }>(
    `/api/admin/revision/chapters/${chapterId}/courses/reorder`,
    { method: 'POST', body: JSON.stringify({ orderedIds }) },
    token,
  )
}
...
export function createModule(
  ...
  return apiFetch<{ module: ContentModule }>(
    `/api/admin/revision/chapters/${chapterId}/courses/${courseId}/modules`,
...
export function duplicateModule(
  ...
  return apiFetch<{ module: ContentModule }>(
    `/api/admin/revision/chapters/${chapterId}/courses/${courseId}/modules/${moduleId}/duplicate`,
    { method: 'POST' },
    token,
  )
}
...
export function reorderModules(
  ...
  return apiFetch<{ chapter: Chapter }>(
    `/api/admin/revision/chapters/${chapterId}/courses/${courseId}/modules/reorder`,
    { method: 'POST', body: JSON.stringify({ orderedIds }) },
    token,
  )
}
...
export function updateModule(
  ...
  return apiFetch<{ module: ContentModule }>(
    `/api/admin/revision/chapters/${chapterId}/courses/${courseId}/modules/${moduleId}`,
    { method: 'PATCH', body: JSON.stringify(payload) },
    token,
  )
}
